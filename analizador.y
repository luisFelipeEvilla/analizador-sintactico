...
%% 
    ...
    CICLO_FLOR: 
        P_FOR A_PARENTESIS ASIGNACION EVALUAR FIN_SENTENCIA INCREMENTO C_PARENTESIS A_LLAVE EXPRESIONES C_LLAVE;
    ...
    COMPARAR: S_IGUAL | S_MAYOR | S_MENOR; 
