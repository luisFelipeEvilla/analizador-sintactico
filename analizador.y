...
%% 
    ...
    | TIPO_DATO P_MAIN A_PARENTESIS C_PARENTESIS A_LLAVE EXPRESIONES C_LLAVE;
    ...
    IF:
        P_IF A_PARENTESIS CONDICION C_PARENTESIS A_LLAVE EXPRESIONES C_LLAVE 
        ...
        | P_IF A_PARENTESIS CONDICION C_PARENTESIS A_LLAVE EXPRESIONES C_LLAVE P_ELSE IF;
